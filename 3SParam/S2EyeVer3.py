...
# 3000 is a number recommended by Harry. As long as it's greater than 1001 then it's fine. Because you can convolve two signals of different lengths# fb is the frequency of the bassband signal    # How fast we are transimitting data. 2GHz == 2Gbit
...
#                                         # Plotting 3 - Sparam and carrier
plt.figure()
plt.plot(abs(Sparam))
plt.plot(carrier_fft)
plt.legend(["Sparam", "carrier"])

# Remember Sparam is already in freq domain
plt.title('Sparam and carrier in freq domain')
plt.show()
